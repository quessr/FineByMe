...
object NetworkUtils {
    fun <T> enqueueCall(call: Call<T>, onSuccess: (Response<T>) -> Unit, onFailure: (String) -> Unit) {
        call.enqueue(object  : Callback<T> {
            override fun onResponse(call: Call<T>, response: Response<T>) {
                if (response.isSuccessful) {
                    ...
                    val errorMessage = ErrorHandler.handleFailure(httpException)
            ...
            override fun onFailure(call: Call<T>, t: Throwable) {
                ...
                val errorMessage = ErrorHandler.handleFailure(t)
                onFailure(errorMessage)
            }
        })
    }
